...
/**
 * Base static class for performing query and update operations on the 'ask_user' table.
 *
 * 
 *
...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nickname', 'firstName', 'lastName', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NICKNAME, self::FIRST_NAME, self::LAST_NAME, self::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nickname' => 1, 'firstName' => 2, 'lastName' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NICKNAME => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::CREATED_AT => 4, ),
