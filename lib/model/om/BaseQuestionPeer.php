...
abstract class BaseQuestionPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'title', 'body', 'interestedUsers', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::TITLE, self::BODY, self::INTERESTED_USERS, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'title' => 2, 'body' => 3, 'interestedUsers' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::TITLE => 2, self::BODY => 3, self::INTERESTED_USERS => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
