...
/**
 * Base static class for performing query and update operations on the 'ask_question' table.
 *
 * 
 *
...
abstract class BaseQuestionPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'title', 'body', 'interestedUsers', 'strippedTitle', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::TITLE, self::BODY, self::INTERESTED_USERS, self::STRIPPED_TITLE, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'title' => 2, 'body' => 3, 'interestedUsers' => 4, 'strippedTitle' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::TITLE => 2, self::BODY => 3, self::INTERESTED_USERS => 4, self::STRIPPED_TITLE => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
