...
abstract class BaseAnswer extends BaseObject  implements Persistent {
  ...
  const PEER = 'AnswerPeer';
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(AnswerPeer::RELEVANCY_UP,AnswerPeer::RELEVANCY_DOWN))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->relevancy_up = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->relevancy_down = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
	 ...
	 * related Relevancys from storage. If this Answer is new, it will return
		...
		if ($this->collRelevancys === null) {
			if ($this->isNew()) {
			   $this->collRelevancys = array();
				...
				$criteria->add(RelevancyPeer::ANSWER_ID, $this->id);
	 ...
	 */
	public function getRelevancysJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
		}
		...
		if ($this->collRelevancys === null) {
			if ($this->isNew()) {
				...
				$this->collRelevancys = RelevancyPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
