...
abstract class BaseUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'UserPeer';
	...
	/**
	 * @var        array Relevancy[] Collection to store aggregation of Relevancy objects.
	 */
	protected $collRelevancys;

	/**
	 * @var        Criteria The criteria used to select the current contents of collRelevancys.
	 */
	private $lastRelevancyCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collRelevancys = null;
			$this->lastRelevancyCriteria = null;
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related Interests from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	...
	public function countInterests(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collInterests === null) {
			if ($this->isNew()) {
				...
				$count = InterestPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	 ...
	 * actually need in User.
	 */
	public function getInterestsJoinQuestion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
		}
		...
		if ($this->collInterests === null) {
			if ($this->isNew()) {
				...
				$this->collInterests = InterestPeer::doSelectJoinQuestion($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collRelevancys collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addRelevancys()
	 */
	public function clearRelevancys()
	{
		$this->collRelevancys = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collRelevancys collection (array).
	 *
	 * By default this just sets the collRelevancys collection to an empty array (like clearcollRelevancys());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	...
	/**
	 * Gets an array of Relevancy objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related Relevancys from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array Relevancy[]
	 * @throws     PropelException
	 */
	public function getRelevancys($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
		}
		...
		if ($this->collRelevancys === null) {
			if ($this->isNew()) {
			   $this->collRelevancys = array();
				...
				$criteria->add(RelevancyPeer::USER_ID, $this->id);
	 ...
	 * @throws     PropelException
	 */
	public function countRelevancys(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collRelevancys === null) {
			if ($this->isNew()) {
				...
				$count = RelevancyPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastRelevancyCriteria) || !$this->lastRelevancyCriteria->equals($criteria)) {
					...
					$count = count($this->collRelevancys);
				}
			} else {
				$count = count($this->collRelevancys);
			}
	...
	public function addRelevancy(Relevancy $l)
	{
		...
		if (!in_array($l, $this->collRelevancys, true)) { // only add it if the **same** object is not already associated
			array_push($this->collRelevancys, $l);
			$l->setUser($this);
		}
	}
	 ...
	 * actually need in User.
	 */
	public function getRelevancysJoinAnswer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
		}
		...
		if ($this->collRelevancys === null) {
			if ($this->isNew()) {
				...
				$this->collRelevancys = RelevancyPeer::doSelectJoinAnswer($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collRelevancys) {
				foreach ((array) $this->collRelevancys as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
