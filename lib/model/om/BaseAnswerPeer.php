...
/**
 * Base static class for performing query and update operations on the 'ask_answer' table.
 *
 * 
 *
...
abstract class BaseAnswerPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'questionId', 'userId', 'body', 'relevancyUp', 'relevancyDown', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::QUESTION_ID, self::USER_ID, self::BODY, self::RELEVANCY_UP, self::RELEVANCY_DOWN, self::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'questionId' => 1, 'userId' => 2, 'body' => 3, 'relevancyUp' => 4, 'relevancyDown' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::QUESTION_ID => 1, self::USER_ID => 2, self::BODY => 3, self::RELEVANCY_UP => 4, self::RELEVANCY_DOWN => 5, self::CREATED_AT => 6, ),
