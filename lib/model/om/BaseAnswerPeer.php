...
abstract class BaseAnswerPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'questionId', 'userId', 'body', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::QUESTION_ID, self::USER_ID, self::BODY, self::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'questionId' => 1, 'userId' => 2, 'body' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::QUESTION_ID => 1, self::USER_ID => 2, self::BODY => 3, self::CREATED_AT => 4, ),
