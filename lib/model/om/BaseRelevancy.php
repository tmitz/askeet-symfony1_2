...
abstract class BaseRelevancy extends BaseObject  implements Persistent {
  ...
  const PEER = 'RelevancyPeer';
	...
	/**
	 * Initializes internal state of BaseRelevancy object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Relevancy The current object (for fluent API support)
	 */
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RelevancyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseRelevancy:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseRelevancy:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseRelevancy:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(RelevancyPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseRelevancy:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			RelevancyPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function getAnswer(PropelPDO $con = null)
	{
		if ($this->aAnswer === null && ($this->answer_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAnswer->addRelevancys($this);
			 */
		}
		return $this->aAnswer;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseRelevancy:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseRelevancy::%s', $method));
    }
