...
/**
 * Base static class for performing query and update operations on the 'ask_interest' table.
 *
 * 
 *
...
abstract class BaseInterestPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('questionId', 'userId', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::QUESTION_ID, self::USER_ID, self::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('questionId' => 0, 'userId' => 1, 'createdAt' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::QUESTION_ID => 0, self::USER_ID => 1, self::CREATED_AT => 2, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new InterestMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseInterestPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseInterestPeer', $criteria, $con);
    }
	...
	public static function addInstanceToPool(Interest $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getQuestionId(), (string) $obj->getUserId()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Interest) {
				$key = serialize(array((string) $value->getQuestionId(), (string) $value->getUserId()));
	...
	public static function doCountJoinQuestion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(InterestPeer::QUESTION_ID,), array(QuestionPeer::ID,), $join_behavior);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(InterestPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseInterestPeer', $c, $con);
    }
		...
		$c->addJoin(array(InterestPeer::QUESTION_ID,), array(QuestionPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Interest) to $obj2 (Question)
	...
	public static function doSelectJoinUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(InterestPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Interest) to $obj2 (User)
				$obj2->addInterest($obj1);
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseInterestPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Interest) to the collection in $obj2 (Question)
				$obj2->addInterest($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Interest) to the collection in $obj3 (User)
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseInterestPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = InterestPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Interest) to the collection in $obj2 (User)
				$obj2->addInterest($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseInterestPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseInterestPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseInterestPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseInterestPeer', $values, $con, $ret);
    }
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion = $criteria->getNewCriterion(InterestPeer::QUESTION_ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(InterestPeer::USER_ID, $value[1]));
				$criteria->addOr($criterion);

				// we can invalidate the cache for this single PK
				InterestPeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 * @return     Interest
	 */
	public static function retrieveByPK($question_id, $user_id, PropelPDO $con = null) {
		$key = serialize(array((string) $question_id, (string) $user_id));
 		if (null !== ($obj = InterestPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the InterestPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the InterestPeer class:
//
// Propel::getDatabaseMap(InterestPeer::DATABASE_NAME)->addTableBuilder(InterestPeer::TABLE_NAME, InterestPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseInterestPeer::DATABASE_NAME)->addTableBuilder(BaseInterestPeer::TABLE_NAME, BaseInterestPeer::getMapBuilder());
